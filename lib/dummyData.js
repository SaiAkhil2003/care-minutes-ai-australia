 ...
 *
 * Facility: Southern Cross Care Group (40 residents)
...
export const facility = {
  name: 'Southern Cross Care Group',
  abn: '12 345 678 901',
  state: 'NSW',
...
export const staff = [
  // — From spec —
  // Qualification expiry dates added for Feature 2 (Qualification Expiry Tracker)
  // TODAY = 2026-04-07. Critical ≤7 days, Expiring ≤30 days, Valid >90 days.
  {
    ...
    ahpraExpiry: '2026-04-13',          // CRITICAL — 6 days
    policeCheckExpiry: '2027-03-15',
    wwcExpiry: '2027-06-20',
    firstAidExpiry: '2027-01-10',
    manualHandlingExpiry: '2027-05-01',
    covidVaccinationDate: '2023-06-15',
  },
  {
    ...
    ahpraExpiry: '2026-09-30',          // valid
    policeCheckExpiry: '2027-08-20',
    wwcExpiry: '2027-11-15',
    firstAidExpiry: '2026-11-30',
    manualHandlingExpiry: '2027-03-22',
    covidVaccinationDate: '2023-04-10',
  },
  {
    ...
    ahpraExpiry: '2026-12-31',          // valid
    policeCheckExpiry: '2027-01-05',
    wwcExpiry: '2028-02-14',
    firstAidExpiry: '2026-08-20',
    manualHandlingExpiry: '2027-07-18',
    covidVaccinationDate: '2023-07-22',
  },
  {
    ...
    ahpraExpiry: null,                  // PCW — not required
    policeCheckExpiry: '2027-04-30',
    wwcExpiry: '2027-09-10',
    firstAidExpiry: '2027-02-28',
    manualHandlingExpiry: '2026-11-15',
    covidVaccinationDate: '2023-03-01',
  },
  {
    ...
    ahpraExpiry: null,
    policeCheckExpiry: '2027-06-25',
    wwcExpiry: '2028-01-30',
    firstAidExpiry: '2026-10-05',
    manualHandlingExpiry: '2027-08-12',
    covidVaccinationDate: '2022-12-10',
  },
  {
    ...
    ahpraExpiry: '2026-11-15',          // valid
    policeCheckExpiry: '2026-04-22',    // Expiring — 15 days
    wwcExpiry: '2027-07-31',
    firstAidExpiry: '2026-09-14',
    manualHandlingExpiry: '2027-01-20',
    covidVaccinationDate: '2023-08-05',
  },
  // — Additional staff (realistic 40-bed roster) —
  {
    ...
    ahpraExpiry: '2026-10-01',          // valid
    policeCheckExpiry: '2027-02-28',
    wwcExpiry: '2027-05-15',
    firstAidExpiry: '2026-05-01',       // Expiring — 24 days
    manualHandlingExpiry: '2027-04-10',
    covidVaccinationDate: '2023-05-20',
  },
  {
    ...
    ahpraExpiry: '2027-01-31',
    policeCheckExpiry: '2027-09-15',
    wwcExpiry: '2028-03-20',
    firstAidExpiry: '2027-03-08',
    manualHandlingExpiry: '2026-12-01',
    covidVaccinationDate: '2023-02-14',
  },
  {
    ...
    ahpraExpiry: null,
    policeCheckExpiry: '2027-11-20',
    wwcExpiry: '2028-04-05',
    firstAidExpiry: '2026-07-18',
    manualHandlingExpiry: '2027-06-30',
    covidVaccinationDate: '2023-09-01',
  },
  {
    ...
    ahpraExpiry: null,
    policeCheckExpiry: '2027-10-12',
    wwcExpiry: '2027-08-25',
    firstAidExpiry: '2026-12-20',
    manualHandlingExpiry: '2027-09-05',
    covidVaccinationDate: '2023-01-30',
  },
  {
    ...
    ahpraExpiry: null,
    policeCheckExpiry: '2027-05-08',
    wwcExpiry: '2027-12-10',
    firstAidExpiry: '2027-05-15',
    manualHandlingExpiry: '2026-10-28',
    covidVaccinationDate: '2022-11-15',
  },
  {
    ...
    ahpraExpiry: null,
    policeCheckExpiry: '2028-01-15',
    wwcExpiry: '2028-06-30',
    firstAidExpiry: '2027-08-22',
    manualHandlingExpiry: '2027-11-10',
    covidVaccinationDate: '2023-10-18',
  },
  {
    ...
    ahpraExpiry: null,
    policeCheckExpiry: '2027-07-20',
    wwcExpiry: '2027-10-05',
    firstAidExpiry: '2026-09-08',
    manualHandlingExpiry: '2027-02-14',
    covidVaccinationDate: '2023-04-25',
  },
  {
    ...
    ahpraExpiry: null,
    policeCheckExpiry: '2027-12-01',
    wwcExpiry: '2028-05-18',
    firstAidExpiry: '2027-06-10',
    manualHandlingExpiry: '2027-10-22',
    covidVaccinationDate: '2023-07-08',
  },
];
...
export const shifts = [
  ...
  // ── Day 30: 06 Apr 2026 — GREEN (8,640 total, full 24h RN) — Monday ─────────
  ...morningFull('2026-04-06'),
  ...afternoonFull('2026-04-06'),
  s('2026-04-06', 'staff-7', 'Patricia Lee', 'RN', '23:00', '07:00', 'Casual'),

  // ── Day 31: 07 Apr 2026 — GREEN (8,640 total, full 24h RN) — Tuesday ────────
  ...morningFull('2026-04-07'),
  ...afternoonFull('2026-04-07'),
  s('2026-04-07', 'staff-7', 'Patricia Lee', 'RN', '23:00', '07:00', 'Casual'),

  // ── Day 32: 08 Apr 2026 — GREEN (8,640 total, full 24h RN) — Wednesday ──────
  ...morningFull('2026-04-08'),
  ...afternoonFull('2026-04-08'),
  s('2026-04-08', 'staff-7', 'Patricia Lee', 'RN', '23:00', '07:00', 'Casual'),

  // ── Day 33: 09 Apr 2026 — GREEN (8,640 total, full 24h RN) — Thursday ───────
  ...morningFull('2026-04-09'),
  ...afternoonFull('2026-04-09'),
  s('2026-04-09', 'staff-7', 'Patricia Lee', 'RN', '23:00', '07:00', 'Casual'),

  // ── TODAY: 10 Apr 2026 — GREEN (8,640 total, 1,920 RN) — Friday ─────────────
  // RN covered 07:00–23:00 | Gap: 11pm–7am (typical overnight gap)
  ...morningFull('2026-04-10'),
  ...afternoonFull('2026-04-10'),
];
...
export const alerts = [
  {
    ...
    message:
      'Southern Cross Care Group is currently on track to meet today\'s care minutes target. ' +
  ...
  },
  {
    ...
    title: 'Care minutes below target — Wednesday 08/04/2026',
    message:
  ...
  },
  {
    ...
    date: '2026-04-07',
    status: 'Action Needed',
    title: 'AMBER status — Tuesday 07/04/2026',
    message:
      'Care minutes for 07 April 2026 reached approximately 86.5% of target — within the AMBER zone. ' +
    ...
    suggestedStaff: [
      'Sarah Chen (RN) 0411 222 333 — available for overtime on Wednesday',
      'Patricia Lee (RN, Casual) 0477 888 999 — contact to confirm this week availability',
    ],
    sentViaEmail: true,
  },
  {
    ...
    date: '2026-04-06',
    status: 'On Track',
    title: 'Compliance met — Monday 06/04/2026',
    message:
      'All care minutes targets were met for 06 April 2026. Total minutes: 8,640 against a target of 8,600. ' +
  ...
  },
  {
    ...
    date: '2026-04-05',
    status: 'Action Needed',
    title: '⚠ NON-COMPLIANT DAY — Sunday 05/04/2026',
    message:
      'URGENT: Southern Cross Care Group was non-compliant on 05 April 2026. ' +
    ...
    gaps: [
      ...
      'Mary Johnson (Agency RN) was unavailable for Sunday',
    ...
    suggestedStaff: [
      ...
      'Mary Johnson (Agency RN) 0466 777 888 — confirm Sunday availability in advance each week',
  ...
  },
  {
    ...
    date: '2026-04-04',
    status: 'On Track',
    title: 'Strong compliance — Saturday 04/04/2026',
    message:
      'Excellent compliance for 04 April 2026. Total care minutes: 9,120 (106% of target). ' +
      'Both morning and afternoon RN teams fully covered. An extra PCW shift (James Anderson) added 480 minutes. ' +
      'Note: Tomorrow (Sunday) is historically a risk day — confirm all RN cover before 17:00 today.',
    gaps: [],
    suggestedStaff: [],
    sentViaEmail: true,
  },
  {
    ...
    date: '2026-04-03',
    status: 'On Track',
    title: 'Compliance met — Friday 03/04/2026',
    message:
      'Care minutes target met for 03 April 2026. Total: 8,640 minutes (100.5%). RN coverage fully compliant at 109%. ' +
      'Current 14-day compliance rate: 10 of 12 days logged = 83.3%. One RED day (05 Apr) and one AMBER day (07 Apr) recorded this week.',
    gaps: [],
    suggestedStaff: [],
    sentViaEmail: false,
  },
...
export const shiftTemplates = [
  {
    id: 'template-1',
    name: 'Standard Week',
    description: 'Standard Mon–Fri staffing with 2 RN per shift block',
    createdAt: '2026-03-01',
    shifts: [
      // Monday–Friday morning (07:00–15:00)
      ...[1,2,3,4,5].flatMap(dow => [
        { staffId: 'staff-1', staffName: 'Sarah Chen',     staffType: 'RN',  employmentType: 'Permanent', dayOfWeek: dow, startTime: '07:00', endTime: '15:00', durationMinutes: 480 },
        { staffId: 'staff-7', staffName: 'Patricia Lee',   staffType: 'RN',  employmentType: 'Casual',    dayOfWeek: dow, startTime: '07:00', endTime: '15:00', durationMinutes: 480 },
        { staffId: 'staff-3', staffName: 'Jennifer Walsh', staffType: 'EN',  employmentType: 'Permanent', dayOfWeek: dow, startTime: '07:00', endTime: '15:00', durationMinutes: 480 },
        { staffId: 'staff-4', staffName: 'David Kim',      staffType: 'PCW', employmentType: 'Permanent', dayOfWeek: dow, startTime: '07:00', endTime: '15:00', durationMinutes: 480 },
        { staffId: 'staff-2', staffName: 'Michael Torres', staffType: 'RN',  employmentType: 'Permanent', dayOfWeek: dow, startTime: '15:00', endTime: '23:00', durationMinutes: 480 },
        { staffId: 'staff-6', staffName: 'Mary Johnson',   staffType: 'RN',  employmentType: 'Agency',    dayOfWeek: dow, startTime: '15:00', endTime: '23:00', durationMinutes: 480 },
        { staffId: 'staff-8', staffName: 'Robert Brown',   staffType: 'EN',  employmentType: 'Permanent', dayOfWeek: dow, startTime: '15:00', endTime: '23:00', durationMinutes: 480 },
        { staffId: 'staff-5', staffName: 'Lisa Nguyen',    staffType: 'PCW', employmentType: 'Permanent', dayOfWeek: dow, startTime: '15:00', endTime: '23:00', durationMinutes: 480 },
      ]),
    ],
  },
  {
    id: 'template-2',
    name: 'Weekend Cover',
    description: 'Sat–Sun weekend staffing roster',
    createdAt: '2026-03-15',
    shifts: [
      ...[6, 7].flatMap(dow => [
        { staffId: 'staff-6', staffName: 'Mary Johnson', staffType: 'RN',  employmentType: 'Agency',    dayOfWeek: dow, startTime: '07:00', endTime: '19:00', durationMinutes: 720 },
        { staffId: 'staff-9', staffName: 'Amy Wilson',   staffType: 'PCW', employmentType: 'Permanent', dayOfWeek: dow, startTime: '07:00', endTime: '15:00', durationMinutes: 480 },
        { staffId: 'staff-4', staffName: 'David Kim',    staffType: 'PCW', employmentType: 'Permanent', dayOfWeek: dow, startTime: '15:00', endTime: '23:00', durationMinutes: 480 },
      ]),
    ],
  },
];
